...
public class KML_Logger extends Thread {
	...
	public String PlaceTheGraph() {
		...
		for (node_data data : this.graph.getV()) {
			s += "<Placemark>" + "<description>" + "</description>" + "<Point>" + "<coordinates>"
					+ data.getLocation().x() + "," + data.getLocation().y() + "," + data.getLocation().z()
	...
	public String PlaceMarkFruit() {
		...
		for (Fruits fruit : f) {
			...
			s += s2 + "</styleUrl>\n";
			s += "        <Point>\n" + "          <coordinates>" + fruit.getLocation().x() + ","
					+ fruit.getLocation().y() + "</coordinates>\n" + "        </Point>\n" + "      </Placemark>\n";
		}
		return s;
	}
	...
	public String PLaceMarkRobots() {
		...
		for (Robots robot : ro) {
			...
			s += "        <Point>\n" + "          <coordinates>" + robot.getLocation().x() + ","
					+ robot.getLocation().y() + "</coordinates>\n" + "        </Point>\n" + "      </Placemark>\n";
